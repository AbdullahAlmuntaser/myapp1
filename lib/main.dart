  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => DashboardProvider()), // Provide DashboardProvider
        ChangeNotifierProvider(create: (_) => AssessmentTypeProvider()),
...
class _AppInitializerState extends State<AppInitializer> {
  ...
  Future<void> _initializeProvidersAndAuth() async {
    ...
    if (authService.isAuthenticated && authService.currentUser != null) {
      ...
      if (!mounted) return;
      final dashboardProvider = Provider.of<DashboardProvider>(context, listen: false); // Get DashboardProvider
      ...
      try {
        await Future.wait([
          ...
          dashboardProvider.fetchDashboardData(), // Fetch dashboard data
        ]);
